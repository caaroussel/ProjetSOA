...
public class MissionDOA {
    ...
    public static void createMission(Mission mission) {
    ...
    public static void updateMissionSeeker(String Seeker, String id) {
    ...
    public static void updateMissionVol(String Vol, String id) {
    ...
    public static void updateMissionStatus(Mission.Status Status, String id) {
    ...
    public static void updateMissionOpinion(String Opinion, String id) {
    ...
    public static Mission.Status getStatus(String id) {
